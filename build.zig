...
pub fn build(b: *std.Build) void {
    ...
    addDependencies(b, lib_unit_tests, opts);
    ...
    addDependencies(b, exe_unit_tests, opts);
...
fn addDependencies(b: *std.Build, step: *std.Build.Step.Compile, opts: anytype) void {
    ...
    step.addCSourceFile(.{ .file = .{ .path = "tree-sitter-zig/src/parser.c" }, .flags = &.{} });
    step.addIncludePath(std.Build.LazyPath{ .path = "." });
}
